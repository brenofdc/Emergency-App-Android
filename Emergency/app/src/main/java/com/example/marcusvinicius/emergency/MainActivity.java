package com.example.marcusvinicius.emergency;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Favorito = (ImageButton)findViewById(R.id.ButtonFavorito);
        Configuracao = (ImageButton)findViewById(R.id.ButtonConfiguracoes);
    }
    ...
    public void abrirConfiguracoes (View view){
        ...
        final ViewGroup viewGroup = (ViewGroup) findViewById(R.id.MainLayout);
        viewGroup.removeAllViews();
        viewGroup.addView(View.inflate(this, R.layout.activity_configuracoes, null));
